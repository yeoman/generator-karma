...
files = [
  <%= testFramework %>,
  <%= testFramework %>_ADAPTER,<% if (testFramework === 'MOCHA') {%>
  'app/bower_components/chai/chai.js',<% }%>
  <% if (framework === 'angular') {  %>'app/bower_components/angular/angular.js',
  'app/bower_components/angular-mocks/angular-mocks.js',
  'app/scripts/*.<%= format %>',
  'app/scripts/**/*.<%= format %>',
  'test/mock/**/*.<%= format %>',
  <% }else if (framework === 'ember') { %>'app/bower_components/jquery/jquery.min.js',
